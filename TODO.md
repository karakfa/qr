...
- Wire `svd.html`, `mondrian.html`, `fold.html`, and `twist.html` into
  the gallery (index cards, thumbnails, README rows, count bump) —
  pages are done; holding off on request.
